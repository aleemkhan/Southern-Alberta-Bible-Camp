...
$(document).ready(function(){
	$.ajax({
		type: "GET",
		url: serverUrl,
		data: {"REQUEST_TYPE":"GET_FOLDER", "STATUS": 1, "TYPE":"PICTURES"},
		dataType: 'json',
		success: function(data){
			...
			if(data.STATUS == "SUCCESS"){
				...
				for(var i=0; i < data.DATA.length; i++){
					html +='<a href="gallery.html#'+data.DATA[i].ID+'" style="text-decoration:none; color:black;">';
					html +='<div class="row">';
				...
				$("#container").html(queryError('briefcase', data.MESSAGE));
			}
